...
import { BottomNavigation,jumpTo } from 'react-native-paper';
...
const App = () => {
  ...
  const [routes] = React.useState([
    ...
    { key: 'test', title: 'Test Two', focusedIcon: 'album' },
    { key: 'test2', title: 'Test Three', focusedIcon: 'history' },
  ...
  useEffect(() => {
    ...
    <Drawer
      ...
      renderDrawerContent={() => {
        return <DrawerPaper.Section title="Thinkfeat">
        <DrawerPaper.Item
          label="First Item"
          active={active === 'first'}
